            ...
            <div class="container">
                ...
                <div class="header-wrap">
                    ...
                    <div class="header-logo">
                        <a href="index.php"><img src="/techwix/assets/images/logo2.png" alt="logo" style="width:170px;height: 70px;"></a>
                    </div>
                    ...
                    <div class="header-menu d-none d-lg-block">
                        ...
                        <div class="header-btn d-none d-xl-block">
                            <a class="btn" href="login-register.php">LOG OUT</a>
                        </div>
                        <!-- Header Toggle Start -->
            ...
            <div class="container">
                ...
                <div class="login-register-wrap">
                    <div class="row gx-5">
                            ...
                            <div class="login-register-box">
                                ...
                                <div class="login-register-form">
                                    <form action="signup_check.php" method="post">
                                        ...
                                        <center><p>Already have an account?<a href="login.php"><span style="color:blue;">Login</span></a></p>
                                        </center>
                                    </form>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                        <center><img src="/techwix/assets/images/login.png" style="margin-top: 18%;width: 300px;height: 300px;"></center>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-12">
                                ...
                                <div class="copyright-text text-center">
                                    <p>© Copyrights 2023 TECH TREND All rights reserved. </p>
                                </div>
